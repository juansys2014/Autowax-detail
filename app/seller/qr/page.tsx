...
const sellerData = {
  ...
  code: "carlos-martinez",
  referralUrl: "https://autowaxsfl.com/book?ref=carlos-martinez",
}
...
export default function SellerQRPage() {
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          ...
          text: `Book your car detailing appointment with Auto Wax South Florida! Use my referral link:`,
  ...
  return (
    <div className="px-4 py-6 flex flex-col items-center min-h-[calc(100vh-80px)]">
      ...
      <p className="text-sm text-neutral-400 mb-8">Share to earn commissions</p>
      ...
      <div className="bg-white rounded-3xl p-6 mb-6 shadow-lg shadow-[#4a8fe8]/10">
        <div className="w-64 h-64 relative">
          ...
          <svg viewBox="0 0 256 256" className="w-full h-full">
            ...
            <rect fill="black" x="96" y="48" width="8" height="8"/>
            <rect fill="black" x="112" y="48" width="8" height="8"/>
            <rect fill="black" x="144" y="48" width="8" height="8"/>
            <rect fill="black" x="160" y="48" width="8" height="8"/>
            
            <rect fill="black" x="88" y="64" width="8" height="8"/>
            <rect fill="black" x="120" y="64" width="8" height="8"/>
            <rect fill="black" x="136" y="64" width="8" height="8"/>
            <rect fill="black" x="168" y="64" width="8" height="8"/>
            ...
            <rect fill="black" x="104" y="88" width="8" height="8"/>
            <rect fill="black" x="136" y="88" width="8" height="8"/>
            <rect fill="black" x="168" y="88" width="8" height="8"/>
            ...
            <rect fill="black" x="72" y="104" width="8" height="8"/>
            <rect fill="black" x="120" y="104" width="8" height="8"/>
            <rect fill="black" x="152" y="104" width="8" height="8"/>
            <rect fill="black" x="184" y="104" width="8" height="8"/>
            <rect fill="black" x="216" y="104" width="8" height="8"/>
            
            <rect fill="black" x="16" y="120" width="8" height="8"/>
            <rect fill="black" x="32" y="120" width="8" height="8"/>
            <rect fill="black" x="56" y="120" width="8" height="8"/>
            <rect fill="black" x="88" y="120" width="8" height="8"/>
            <rect fill="black" x="112" y="120" width="8" height="8"/>
            <rect fill="black" x="136" y="120" width="8" height="8"/>
            <rect fill="black" x="160" y="120" width="8" height="8"/>
            <rect fill="black" x="192" y="120" width="8" height="8"/>
            <rect fill="black" x="232" y="120" width="8" height="8"/>
            
            <rect fill="black" x="16" y="136" width="8" height="8"/>
            <rect fill="black" x="48" y="136" width="8" height="8"/>
            <rect fill="black" x="64" y="136" width="8" height="8"/>
            <rect fill="black" x="96" y="136" width="8" height="8"/>
            <rect fill="black" x="128" y="136" width="8" height="8"/>
            <rect fill="black" x="168" y="136" width="8" height="8"/>
            <rect fill="black" x="200" y="136" width="8" height="8"/>
            <rect fill="black" x="224" y="136" width="8" height="8"/>
            
            <rect fill="black" x="16" y="152" width="8" height="8"/>
            <rect fill="black" x="32" y="152" width="8" height="8"/>
            <rect fill="black" x="56" y="152" width="8" height="8"/>
            <rect fill="black" x="72" y="152" width="8" height="8"/>
            <rect fill="black" x="104" y="152" width="8" height="8"/>
            <rect fill="black" x="136" y="152" width="8" height="8"/>
            <rect fill="black" x="152" y="152" width="8" height="8"/>
            <rect fill="black" x="184" y="152" width="8" height="8"/>
            <rect fill="black" x="208" y="152" width="8" height="8"/>
            <rect fill="black" x="232" y="152" width="8" height="8"/>
            
            <rect fill="black" x="16" y="168" width="8" height="8"/>
            <rect fill="black" x="48" y="168" width="8" height="8"/>
            <rect fill="black" x="80" y="168" width="8" height="8"/>
            <rect fill="black" x="120" y="168" width="8" height="8"/>
            <rect fill="black" x="144" y="168" width="8" height="8"/>
            <rect fill="black" x="176" y="168" width="8" height="8"/>
            <rect fill="black" x="216" y="168" width="8" height="8"/>
            
            {/* Bottom right section */}
            <rect fill="black" x="88" y="184" width="8" height="8"/>
            <rect fill="black" x="104" y="184" width="8" height="8"/>
            <rect fill="black" x="136" y="184" width="8" height="8"/>
            <rect fill="black" x="168" y="184" width="8" height="8"/>
            <rect fill="black" x="184" y="184" width="8" height="8"/>
            <rect fill="black" x="208" y="184" width="8" height="8"/>
            <rect fill="black" x="232" y="184" width="8" height="8"/>
            
            <rect fill="black" x="96" y="200" width="8" height="8"/>
            <rect fill="black" x="128" y="200" width="8" height="8"/>
            <rect fill="black" x="152" y="200" width="8" height="8"/>
            <rect fill="black" x="176" y="200" width="8" height="8"/>
            <rect fill="black" x="200" y="200" width="8" height="8"/>
            <rect fill="black" x="224" y="200" width="8" height="8"/>
            
            <rect fill="black" x="88" y="216" width="8" height="8"/>
            <rect fill="black" x="112" y="216" width="8" height="8"/>
            <rect fill="black" x="144" y="216" width="8" height="8"/>
            <rect fill="black" x="168" y="216" width="8" height="8"/>
            <rect fill="black" x="192" y="216" width="8" height="8"/>
            <rect fill="black" x="216" y="216" width="8" height="8"/>
            
            <rect fill="black" x="96" y="232" width="8" height="8"/>
            <rect fill="black" x="120" y="232" width="8" height="8"/>
            <rect fill="black" x="136" y="232" width="8" height="8"/>
            <rect fill="black" x="160" y="232" width="8" height="8"/>
            <rect fill="black" x="184" y="232" width="8" height="8"/>
            <rect fill="black" x="208" y="232" width="8" height="8"/>
            <rect fill="black" x="232" y="232" width="8" height="8"/>
      ...
      <p className="text-sm text-neutral-400 mb-8">@{sellerData.code}</p>
      ...
      <div className="bg-[#1a1a1a] rounded-2xl p-4 border border-[#2a2a2a] w-full max-w-xs">
        <div className="flex items-start gap-3">
          ...
          <p className="text-sm text-neutral-300 leading-relaxed">
            Show this QR code to your clients so they can book their appointment. You&apos;ll earn a commission for every completed service.
          </p>
        </div>
      </div>
    </div>
