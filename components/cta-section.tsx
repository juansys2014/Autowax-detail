  ...
  return (
    <section className="py-20 sm:py-28 bg-gradient-to-r from-navy via-secondary to-navy relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="font-heading text-4xl sm:text-5xl lg:text-6xl text-white mb-6">{t.cta.title}</h2>
        <p className="text-white/80 text-lg sm:text-xl mb-10 max-w-2xl mx-auto">{t.cta.description}</p>
        <Button
          size="lg"
