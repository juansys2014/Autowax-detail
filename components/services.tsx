...
const icons = [CarIcon, SparkleIcon, ShieldIcon, WindIcon, LightbulbIcon, FilmIcon]
    ...
    <section id="services" className="py-20 sm:py-32 bg-background">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <p className="font-condensed text-royal uppercase tracking-widest text-sm mb-4">{t.services.label}</p>
          <h2 className="font-heading text-4xl sm:text-5xl lg:text-6xl text-white mb-6">{t.services.title}</h2>
          <p className="text-muted-foreground max-w-2xl mx-auto text-lg">{t.services.description}</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {t.services.items.map((service, index) => {
            ...
            return (
              ...
              >
                <span className="font-condensed text-muted-foreground/30 text-6xl font-bold">{num}</span>
