...
export function Hero() {
  ...
  const stats = [
    { icon: <StarIcon />,     value: "5",    label: t.hero.stats.rating },
    { icon: <ShieldIcon />,   value: "100%", label: t.hero.stats.licensed },
    { icon: <SparklesIcon />, value: "6",    label: t.hero.stats.services },
    { icon: <MapPinIcon />,   value: "FL",   label: t.hero.stats.location },
  ]
            ...
            {stats.map((stat, index) => (
              ...
              >
                <div className="flex items-center justify-center gap-2 mb-2">
                  {stat.icon}
                  <span className="font-heading text-2xl sm:text-3xl text-white">{stat.value}</span>
                </div>
